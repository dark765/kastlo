...
redis:set(kastlo.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(kastlo..'lock:join:'..msg.chat_id_,true)
...
redis:del(kastlo..'lock:join:'..msg.chat_id_)
return "*♡ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n♡ ** تم فتح الدخول بالرابط \n*" 
end


local function ikastlo(msg,MsgText)

Channel = redis:get(kastlo..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(kastlo..'joinchnl') then
...
redis:setex(kastlo..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(kastlo..'CheckExpire::'..msg.chat_id_) then 
redis:set(kastlo..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(kastlo..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(kastlo..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(kastlo..'CheckExpire::'..msg.chat_id_) then 
redis:set(kastlo..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(kastlo..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(kastlo..'CheckExpire::'..msg.chat_id_) then 
redis:set(kastlo..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(kastlo..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(kastlo..'CheckExpire::'..msg.chat_id_) then 
redis:set(kastlo..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(kastlo..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(kastlo..'group:name'..msg.chat_id_) or '')
redis:set(kastlo..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(kastlo..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. kastlo..'')
...
if not msg.Director and redis:get(kastlo..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(kastlo..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(kastlo..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(kastlo..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(kastlo..'admins:'..msg.chat_id_)
redis:del(kastlo..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(kastlo..'owners:'..msg.chat_id_)
redis:del(kastlo..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(kastlo..'whitelist:'..msg.chat_id_)
redis:del(kastlo..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(kastlo..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(kastlo..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(kastlo..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(kastlo..'linkGroup'..msg.sender_user_id_,300,true)
return '♡ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(kastlo..'linkGroup'..msg.chat_id_) then 
return "♡ ** اوه لا يوجد رابط .\n♡ **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(kastlo..'group:name'..msg.chat_id_)
local GroupLink = redis:get(kastlo..'linkGroup'..msg.chat_id_)
...
local Text = "♡ رابـط الـمـجـمـوعه ♡ \n"..Flter_Markdown(redis:get(kastlo..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(kastlo..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(kastlo..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "♡ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(kastlo..':Filter_Word:'..msg.chat_id_)
...
redis:del(kastlo..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(kastlo..'welcome:msg'..msg.chat_id_) then 
return "♡ ** اوه هنالك خطأ .\n♡ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(kastlo..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(kastlo..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♡ عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(kastlo..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "♡ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(kastlo..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♡ عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(kastlo..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(kastlo..'banned:'..msg.chat_id_)
if #list == 0 then return "*♡ لا يوجد مستخدمين محظورين  *" end
message = '♡ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(kastlo..'banned:'..msg.chat_id_)
return "♡ **أهلا عزيزي "..msg.TheRankCmd.."   \n♡  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(kastlo..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "♡ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(kastlo..'is_silent_users:'..msg.chat_id_)
...
redis:del(kastlo..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "♡ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(kastlo..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(kastlo..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "♡ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(kastlo..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(kastlo..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(kastlo..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(kastlo..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(kastlo..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(kastlo..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(kastlo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(kastlo..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(kastlo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(kastlo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(kastlo.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(kastlo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(kastlo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(kastlo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(kastlo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(kastlo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(kastlo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(kastlo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(kastlo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(kastlo..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(kastlo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "♡ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '♡ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(kastlo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(kastlo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "♡ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(kastlo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(kastlo..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "♡ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(kastlo..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(kastlo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(kastlo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(kastlo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(kastlo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(kastlo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(kastlo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(kastlo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(kastlo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(kastlo..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(kastlo..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(kastlo..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(kastlo..'welcome:msg'..msg.chat_id_))
else 
return "♡ **أهلا عزيزي "..msg.TheRankCmd.."  \n♡ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(kastlo..'group:ids')
...
local pv = redis:smembers(kastlo..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(kastlo..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(kastlo..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[♡ اهلا انا بوت]]..redis:get(kastlo..':NameBot:')..[[ .
...
redis:setex(kastlo..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '♡ حسننا عزيزي .\n♡ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(kastlo..':addnumberusers',MsgText[2]) 
return '♡ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'♡ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(kastlo..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "♡ **هذا الامر يخص {المطور} فقط  \n" end
return '♡ ** عدد المجموعات المفعلة » `'..redis:scard(kastlo..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "♡ **هذا الامر يخص {المطور} فقط  \n" end
return '♡ **عدد المشتركين في البوت : `'..redis:scard(kastlo..'users')..'` \n'
end
...
if not msg.SudoUser then return "♡ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(kastlo..'group:ids',MsgText[2]) then
local name_gp = redis:get(kastlo..'group:name'..MsgText[2])
...
return redis:get(kastlo..":TEXT_SUDO") or '♡ لا توجد كليشه المطور .\n♡ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"♡ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(kastlo..'lock_brod') then 
return "♡ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(kastlo..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(kastlo..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(kastlo..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(kastlo..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(kastlo..'welcom:witting'..msg.sender_user_id_,
kastlo..'rulse:witting'..msg.sender_user_id_,
kastlo..'rulse:witting'..msg.sender_user_id_,
kastlo..'name:witting'..msg.sender_user_id_,
kastlo..'about:witting'..msg.sender_user_id_,
kastlo..'fwd:all'..msg.sender_user_id_,
kastlo..'fwd:pv'..msg.sender_user_id_,
kastlo..'fwd:groups'..msg.sender_user_id_,
kastlo..'namebot:witting'..msg.sender_user_id_,
kastlo..'addrd_all:'..msg.sender_user_id_,
kastlo..'delrd:'..msg.sender_user_id_,
kastlo..'addrd:'..msg.sender_user_id_,
kastlo..'delrdall:'..msg.sender_user_id_,
kastlo..'text_sudo:witting'..msg.sender_user_id_,
kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_,
kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/mohamed2512000/kastlofile/main/GetVersion.txt' ) or 0
print(GetVerison.." > "..version)
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,' *╿* يوجد تحديث جديد الان \n*╽* جاري تنزيل وتثبيت التحديث  ...' )
redis:set(kastlo..":VERSION",GetVerison)
return false
else
...
return '♡ اصدار سورس كاستيلو: *v'..version..'* \n'
end
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/ALAFANDY0"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : كاستيلو](https://t.me/ALAFANDY0)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "المبرمج دارك" and msg.type == "pv" then
local inline = {{{text="-المـبـرمج دارك اضـغـط هـنـآ ",url="https://t.me/F6F6FF"}}}
send_key(msg.sender_user_id_,'   [المبرمج دارك](https://t.me/F6F6FF)' ,nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '♡ الاحصائيات . \n\n♡ **عدد المجموعات المفعله : '..redis:scard(kastlo..'group:ids')..'\n♡ **عدد المشتركين في البوت : '..redis:scard(kastlo..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(kastlo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(kastlo..'replay:'..msg.chat_id_)
local photo 	= redis:exists(kastlo..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(kastlo..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(kastlo..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(kastlo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(kastlo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(kastlo..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(kastlo..'replay:'..msg.chat_id_,kastlo..'replay_photo:group:'..msg.chat_id_,kastlo..'replay_voice:group:'..msg.chat_id_,
kastlo..'replay_animation:group:'..msg.chat_id_,kastlo..'replay_audio:group:'..msg.chat_id_,kastlo..'replay_sticker:group:'..msg.chat_id_,kastlo..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(kastlo..'replay:all')
local photo 	= redis:exists(kastlo..'replay_photo:group:')
local voice 	= redis:exists(kastlo..'replay_voice:group:')
local imation 	= redis:exists(kastlo..'replay_animation:group:')
local audio 	= redis:exists(kastlo..'replay_audio:group:')
local sticker 	= redis:exists(kastlo..'replay_sticker:group:')
local video 	= redis:exists(kastlo..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(kastlo..'replay:all',kastlo..'replay_photo:group:',kastlo..'replay_voice:group:',kastlo..'replay_animation:group:',kastlo..'replay_audio:group:',kastlo..'replay_sticker:group:',kastlo..'replay_video:group:')
...
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(kastlo..'delrdall:'..msg.sender_user_id_,true) 
return "♡ حسننا عزيزي  .\n♡ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(kastlo..'delrd:'..msg.sender_user_id_,true)
return "♡ حسننا عزيزي  .\n♡ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "♡ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(kastlo..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(kastlo..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(kastlo..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(kastlo..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(kastlo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(kastlo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(kastlo..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(kastlo..'replay:all')
local photo 	= redis:hkeys(kastlo..'replay_photo:group:')
local voice 	= redis:hkeys(kastlo..'replay_voice:group:')
local imation 	= redis:hkeys(kastlo..'replay_animation:group:')
local audio 	= redis:hkeys(kastlo..'replay_audio:group:')
local sticker 	= redis:hkeys(kastlo..'replay_sticker:group:')
local video 	= redis:hkeys(kastlo..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '♡ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "♡ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(kastlo..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "♡ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(kastlo..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n♡ " end
if not redis:get(kastlo..'lave_me'..msg.chat_id_) then 
return "♡ **أهلا عزيزي "..msg.TheRankCmd.."\n♡ ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(kastlo..'lave_me'..msg.chat_id_) 
return "♡ **أهلا عزيزي "..msg.TheRankCmd.."\n♡ ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "♡ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n♡ " end
if redis:get(kastlo..'lave_me'..msg.chat_id_) then 
return "♡ **أهلا عزيزي "..msg.TheRankCmd.."\n♡ ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(kastlo..'lave_me'..msg.chat_id_,true)  
...
✧DEV₁ :- [𝙺𝙰𝚁𝙴𝙴𝙼 𝙼𝚁𝚆𝙰𝙽🇦🇷💘.](t.me/kareemmrwan1)

✧[SOURCE CH](https://t.me/ALAFANDY0)

✧[TO TALK TO US](https://t.me/kareemmrwan1149BOT)
]]
end
...
⌔︙رومانسي 𖠽
 — — — — — — — — —
𝙲𝙷 𖣲. :[SOURCE KASTLO𖠉𖡶 ](https://t.me/ALAFANDY0)
]]
end
...
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(kastlo..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"♡ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(kastlo..":UserNameChaneel")
if UserChaneel then
...
if redis:get(kastlo..'welc'..msg.chat_id_) == 'on' then
...
local hash = kastlo..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(kastlo..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(kastlo..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(kastlo..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'♡ اهلا عزيزي \n♡ تم تثبيت الامر الجديد\n✓')
redis:del(kastlo..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "♡ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(kastlo..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(kastlo..'CmD:'..msg.chat_id_,cmd)
redis:srem(kastlo..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"♡ اهلا عزيزي\nالامر >"..cmd.."\n♡ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "♡ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(kastlo..'CmD:'..msg.chat_id_)
redis:del(kastlo..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"♡ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "♡ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(kastlo..'CmDlist:'..msg.chat_id_)
local t = '♡ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(kastlo..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(kastlo..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(kastlo..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(kastlo..'welc'..msg.chat_id_,'off')
redis:del(kastlo..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,kastlo)   
if kastlo.content_.ID == "MessageSticker" then        
local bd = kastlo.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(kastlo..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(kastlo..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*♡ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(kastlo..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(kastlo..'users',msg.sender_user_id_)
if redis:get(kastlo..'lock_service') then 
text = [[♡ أهلاً انا بوت   []]..redis:get(kastlo..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(kastlo.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(kastlo..'lock_twasel') then
...
redis:setex(kastlo.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(kastlo..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(kastlo..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(kastlo..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n♡ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(kastlo..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه صوره للرد بنجاح\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(kastlo..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه بصمه صوت للرد بنجاح\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(kastlo..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه متحركه للرد بنجاح\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(kastlo..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه فيديو للرد بنجاح\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(kastlo..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه للصوت للرد بنجاح\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(kastlo..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(kastlo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(kastlo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(kastlo..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ♡ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(kastlo..'replay_photo:group:',klma,photo_id)
redis:del(kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه صوره للرد العام\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(kastlo..'replay_voice:group:',klma,voice_id)
redis:del(kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه بصمه صوت للرد العام\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(kastlo..'replay_animation:group:',klma,animation_id)
redis:del(kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه متحركه للرد العام\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(kastlo..'replay_video:group:',klma,video_id)
redis:del(kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه فيديو للرد العام\n♡ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(kastlo..'replay_audio:group:',klma,audio_id)
redis:del(kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم اضافه للصوت للرد العام\n♡ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(kastlo..'replay_sticker:group:',klma,sticker_id)
redis:del(kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(kastlo..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(kastlo..":ForceSub:"..msg.sender_user_id_)
...
redis:set(kastlo..":UserNameChaneel",msg.text)
...
if redis:get(kastlo..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(kastlo..'namebot:witting'..msg.sender_user_id_)
redis:set(kastlo..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"♡ تم تغير اسم البوت  .\n♡ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(kastlo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(kastlo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(kastlo..'replay_photo:group:',msg.text)
redis:hdel(kastlo..'replay_voice:group:',msg.text)
redis:hdel(kastlo..'replay_animation:group:',msg.text)
redis:hdel(kastlo..'replay_audio:group:',msg.text)
redis:hdel(kastlo..'replay_sticker:group:',msg.text)
redis:hdel(kastlo..'replay_video:group:',msg.text)
redis:setex(kastlo..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"♡ جيد , يمكنك الان ارسال جوا ب الردالعام \n♡ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(kastlo..'delrdall:'..msg.sender_user_id_) then
redis:del(kastlo..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(kastlo..'replay:all',msg.text)
local photo =redis:hget(kastlo..'replay_photo:group:',msg.text)
local voice = redis:hget(kastlo..'replay_voice:group:',msg.text)
local animation = redis:hget(kastlo..'replay_animation:group:',msg.text)
local audio = redis:hget(kastlo..'replay_audio:group:',msg.text)
local sticker = redis:hget(kastlo..'replay_sticker:group:',msg.text)
local video = redis:hget(kastlo..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'♡ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(kastlo..'replay:all',msg.text)
redis:hdel(kastlo..'replay_photo:group:',msg.text)
redis:hdel(kastlo..'replay_voice:group:',msg.text)
redis:hdel(kastlo..'replay_audio:group:',msg.text)
redis:hdel(kastlo..'replay_animation:group:',msg.text)
...
if redis:get(kastlo..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(kastlo..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(kastlo..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "♡ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(kastlo..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(kastlo..'welcom:witting'..msg.sender_user_id_) 
redis:set(kastlo..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"♡ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(kastlo..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(kastlo..'rulse:witting'..msg.sender_user_id_) 
redis:set(kastlo..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'♡ ** مرحبآ عزيزي\n♡ تم حفظ القوانين بنجاح .\n♡ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(kastlo..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(kastlo..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(kastlo..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(kastlo..'linkGroup'..msg.sender_user_id_,link) 
redis:set(kastlo..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'♡ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(kastlo..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(kastlo..'about:witting'..msg.sender_user_id_) 
...
if redis:get(kastlo..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(kastlo..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(kastlo..'users')  
local groups = redis:smembers(kastlo..'group:ids')
...
if redis:get(kastlo..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(kastlo..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(kastlo..'users')
if #pv >= 300 then
...
if redis:get(kastlo..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(kastlo..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(kastlo..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(kastlo..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(kastlo..':WELCOME_BOT'),[[♡أهلاً انا بوت ]]..redis:get(kastlo..':NameBot:')..[[
♡ أختصاصي حماية‌‏ المجموعات
♡ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(kastlo..'fwd:'..msg.sender_user_id_) then
redis:del(kastlo..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(kastlo..'users')
local groups = redis:smembers(kastlo..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(kastlo..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(kastlo..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(kastlo..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'♡ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(kastlo..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(kastlo..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(kastlo..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(kastlo..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(kastlo..'replay:'..msg.chat_id_,msg.text)
redis:hdel(kastlo..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(kastlo..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(kastlo..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(kastlo..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(kastlo..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(kastlo..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(kastlo..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"♡ جيد , يمكنك الان ارسال جواب الرد \n♡ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(kastlo..'delrd:'..msg.sender_user_id_) then
redis:del(kastlo..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(kastlo..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(kastlo..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(kastlo..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(kastlo..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(kastlo..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(kastlo..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(kastlo..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'♡ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(kastlo..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(kastlo..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(kastlo..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(kastlo..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(kastlo..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(kastlo..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(kastlo..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(kastlo..'welcome:msg'..msg.chat_id_) or "♡ اهلاً عزيزي {الاسم}\n♡ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n♡ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(kastlo..'rulse:msg'..msg.chat_id_) or "♡ مرحباً عزيري القوانين كلاتي .\n♡ ممنوع نشر الروابط\n♡ ممنوع التكلم او نشر صور اباحيه\n♡ ممنوع  اعاده توجيه\n♡ ممنوع التكلم بالسياسة\n♡ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(kastlo..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(kastlo..'welcome:msg'..msg.chat_id_) or "♡ اهلن بك عزيزي {الاسم}\n♡ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n♡ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(kastlo..'rulse:msg'..msg.chat_id_) or "♡ مرحباً عزيري القوانين كلاتي .\n♡ ممنوع نشر الروابط\n♡ ممنوع التكلم او نشر صور اباحيه\n♡ ممنوع  اعاده توجيه\n♡ ممنوع التكلم بالسياسة\n♡ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(kastlo..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(kastlo..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(kastlo..'welcome:get'..msg.chat_id_)
end
redis:setex(kastlo..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(kastlo..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(kastlo..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_kastlo = (redis:get(kastlo..'num_msg_kastlo'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_kastlo) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(kastlo..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"♡ العضو » "..USERNAME.."\n♡ قمـت بتكرار اكثر مـن "..NUM_MSG_kastlo.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(kastlo..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(kastlo..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(kastlo..'lock_woring'..msg.chat_id_) and not redis:get(kastlo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(kastlo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(kastlo..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(kastlo..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'♡ ** لا يمكنني مسح الرساله المخالفه .\n♡ ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(kastlo..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(kastlo..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(kastlo..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(kastlo..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(kastlo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(kastlo..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(kastlo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(kastlo..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(kastlo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(kastlo..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(kastlo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(kastlo..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(kastlo..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(kastlo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(kastlo..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(kastlo..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(kastlo..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(kastlo..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(kastlo..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(kastlo..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(kastlo..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(kastlo..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(kastlo..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(kastlo..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(kastlo..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(kastlo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(kastlo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(kastlo..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(kastlo..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(kastlo..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(kastlo..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kastlo..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(kastlo..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kastlo..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kastlo..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kastlo..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(kastlo..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kastlo..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(kastlo..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kastlo..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kastlo..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(kastlo..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text:match(Bot_Name.."كيفك") then 
  ...
  elseif Text== "ارض زيكولا"  then return sendMsg(msg.chat_id_,msg.id_,"[ارض زيكولا  𖡼](https://t.me/SOURCE_KSTLO/3.")
  elseif Text== "مقبره الحيوانات."  then return sendMsg(msg.chat_id_,msg.id_," [مقبره الحيوانات 𖡼](https://t.me/SOURCE_KSTLO/8)")
  elseif Text== "التحرر"  then return sendMsg(msg.chat_id_,msg.id_,"[التحرر  𖡼](https://t.me/SOURCE_KSTLO/9)")
  elseif Text== "روايه المخلوق"  then return sendMsg(msg.chat_id_,msg.id_,"[روايه المخلوق  𖡼](https://t.me/SOURCE_KSTLO/5)")
  elseif Text== "في حضره الجن"  then return sendMsg(msg.chat_id_,msg.id_,"[في حضره الجن  𖡼](https://t.me/SOURCE_KSTLO/6).")
  elseif Text== "موسوعه الظلام"  then  return sendMsg(msg.chat_id_,msg.id_,"[موسوعه الظلام  𖡼](https://t.me/SOURCE_KSTLO/4)."  )
  elseif Text== "لقاء مع كاتب الرعب"  then return sendMsg(msg.chat_id_,msg.id_,"[لقاء مع كاتب الرعب  𖡼](https://t.me/SOURCE_KSTLO/7) .")
  ...
  elseif Text== "هيه"  then return sendMsg(msg.chat_id_,msg.id_,"وبعدين" )
    elseif Text== "ما تخبئه لنا النجوم"  then return sendMsg(msg.chat_id_,msg.id_,"[ما تخبئه لنا النجوم  𖡼](https://t.me/SOURCE_KSTLO/18).")
  elseif Text== "بعد النسيان."  then return sendMsg(msg.chat_id_,msg.id_," [بعد النسيان  𖡼](https://t.me/SOURCE_KSTLO/19)  ")
  elseif Text== "يوميات كئيب"  then return sendMsg(msg.chat_id_,msg.id_,"[يوميات كئيب  𖡼](https://t.me/SOURCE_KSTLO/20)")
  elseif Text== "الشفق"  then return sendMsg(msg.chat_id_,msg.id_,"[روايه الشفق الجزء الاول  𖡼](https://t.me/SOURCE_KSTLO/21)")
  elseif Text== "كبرياء وتحمل"  then return sendMsg(msg.chat_id_,msg.id_,"[كبرياء وتحمل  𖡼](https://t.me/SOURCE_KSTLO/22).")
  elseif Text== "الامير السعيد"  then  return sendMsg(msg.chat_id_,msg.id_,"[الامير السعيد  𖡼](https://t.me/SOURCE_KSTLO/23)."  )
  elseif Text== "الانسان الاخير"  then return sendMsg(msg.chat_id_,msg.id_,"[الانسان الاخير  𖡼](https://t.me/SOURCE_KSTLO/24) .")
  ...
  elseif Text== "واختفي كل شئ"  then return sendMsg(msg.chat_id_,msg.id_,"[واختفي كل شئ  𖡼](https://t.me/SOURCE_KSTLO/37)")
  elseif Text== "جثه في الخندق"  then return sendMsg(msg.chat_id_,msg.id_," [جثة في الخندق  𖡼](https://t.me/SOURCE_KSTLO/37) ")
  elseif Text== "اللوح الازرق"  then return sendMsg(msg.chat_id_,msg.id_,"[اللوح الازرق  𖡼](https://t.me/SOURCE_KSTLO/35)")
  elseif Text== "نيلوفر الاسود"  then return sendMsg(msg.chat_id_,msg.id_,"[نيلوفر الاسود  𖡼](https://t.me/SOURCE_KSTLO/34)")
  elseif Text== "في القطار السعيد"  then return sendMsg(msg.chat_id_,msg.id_,"[في القطار السريع  𖡼](https://t.me/SOURCE_KSTLO/33).")
  elseif Text== "الرمز المفقود"  then  return sendMsg(msg.chat_id_,msg.id_,"[الرمز المفقود  𖡼](https://t.me/SOURCE_KSTLO/32)."  )
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/ALAFANDY0) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/ALAFANDY0)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/ALAFANDY0)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/ALAFANDY0)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/ALAFANDY0)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/ALAFANDY0) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/ALAFANDY0)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/ALAFANDY0)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/ALAFANDY0)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/ALAFANDY0)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..kastlo..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(kastlo..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(kastlo..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(kastlo..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(kastlo..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(kastlo..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(kastlo..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(kastlo..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(kastlo..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(kastlo..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'♡ انتهى الاشتراك في احد المجموعات .\n♡ المجموعه : '..FlterName(redis:get(kastlo..'group:name'..msg.chat_id_))..'.\n♡ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'♡ انتهى الاشتراك البوت.\n♡ سوف اغادر المجموعه فرصه سعيده .\n♡ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(kastlo..'ExpireDate:'..msg.chat_id_) / 86400)
