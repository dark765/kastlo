...
elseif msg.sender_user_id_ == 62827373728191919 then 
msg.TheRank =  ' مطور السورس '
msg.Rank = 1
...
SUDO_USER = redis:hgetall(kastlo..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(kastlo..':WELCOME_BOT'),[[• مرحباً انا بوت ]]..redis:get(kastlo..':NameBot:')..[[ .
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/mohamed2512000/SouRcekastlo/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/mohamed2512000/SouRcekastlo/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/mohamed2512000/SouRcekastlo/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/mohamed2512000/SouRcekastlo/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/mohamed2512000/SouRcekastlo/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/mohamed2512000/SouRcekastlo/main/plugins/games.lua','./plugins/games.lua')
