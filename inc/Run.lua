...
▀             ████
              ...
              ███████      ██               ██    ██        ██          ██    ██                                                                                                                                                                                                                               
                                                                                                                                                                                                                                                                                                                                                                                             ███
KASTLO ✾ @F6f6Ff
│تم تطوير وبرمجة السورس من قبل المبرمج دارك .
│@F6f6Ff
#-------------------------------------------------------------------
]]
...
kastlo = Token:match("(%d+)")
redis:set(kastlo..":VERSION",1)
redis:set(kastlo..":SUDO_ID:",SUDO_USER)
redis:set(kastlo..":DataCenter:",'German')
redis:set(kastlo..":UserNameBot:",BOT_User)
redis:set(kastlo..":NameBot:",BOT_NAME)
redis:hset(kastlo..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
redis:set("TH3kastlo_INSTALL","Yes")
info = {}
...
KASTLO ✾ @F6f6Ff
│
تم تطوير وبرمجة السورس من قبل المبرمج داركᐂ .
│@F6f6Ff
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
...
kastlo = Token:match("(%d+)")
our_id = tonumber(kastlo)
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(kastlo..":UserNameBot:")
SUDO_ID = tonumber(redis:get(kastlo..":SUDO_ID:"))
SUDO_USER = redis:hgetall(kastlo..'username:'..SUDO_ID).username
version = redis:get(kastlo..":VERSION")
DataCenter = redis:get(kastlo..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..kastlo..')\027[0;32m\n'
...
if msg.type == "pv" and redis:get(kastlo..':mute_pv:'..msg.chat_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end

if redis:get(kastlo..'sender:'..msg.sender_user_id_..':flood') then
...
if redis:get(kastlo..'group:add'..msg.chat_id_) then 
...
msg.TheRank =  'المبرمج دارك'
msg.Rank = 1
elseif msg.sender_user_id_ == 1078602906 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
elseif msg.sender_user_id_ == 1019610884 then 
msg.TheRank =  ' المبرمج تركي '
msg.Rank = 1
...
msg.TheRankCmd = 'كاستلو' 
msg.TheRank = 'مطور اساسي' 
msg.Rank = 1
elseif redis:sismember(kastlo..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = 'كاستلو'
msg.TheRank = 'مطور البوت'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(kastlo..':KARA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء الاساسي'
msg.TheRank = 'المنشىء الاساسي'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(kastlo..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء'
msg.TheRank = 'المنشىء'
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(kastlo..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير' 
msg.TheRank = 'مدير البوت' 
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(kastlo..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن'
msg.TheRank = 'ادمن في البوت'
msg.Rank = 6
elseif msg.GroupActive and redis:sismember(kastlo..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(kastlo..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(kastlo..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(kastlo..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(kastlo..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(kastlo..':WELCOME_BOT'),[[▪️ مرحباً انا بوت ]]..redis:get(kastlo..':NameBot:')..[[ .
▪️ اختـصاصـي حمايـة الـمجموعات
▪️ تأكد من رفعـك للبـوت مشـرف في مجموعـتك واكتب تفعـيل 
قناة سورس كاستلو ❥ @ALAFANDY0
...
if msg.GroupActive and redis:get(kastlo..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
return false 
end
...
if msg.Admin then redis:srem(kastlo..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(kastlo..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(kastlo..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.kastlo then 
if msg.text and ScriptFile.ikastlo then
for k, kastlo in pairs(ScriptFile.kastlo) do
local SearchText = msg.text:match(kastlo)
if SearchText then
if not CheckFlood(msg) then
return false 
end

local GetMsg = ScriptFile.ikastlo(msg,{msg.text:match(kastlo)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",kastlo.." | Plugin is: \27[1;32mScript.lua\27[0m")
...
if ScriptFile.dkastlo then
if ScriptFile.dkastlo(msg) == false then
return false
end
...
if Plug.kastlo then 
if msg.text and Plug.ikastlo then
for k, kastlo in pairs(Plug.kastlo) do
local SearchText = msg.text:match(kastlo)
if SearchText then
if not CheckFlood(msg) then
return false
...
Mohammad = msg.text
if Mohammad then
if redis:sismember(kastlo..'CmDlist:'..msg.chat_id_,Mohammad) then
mmdi = redis:hget(kastlo..'CmD:'..msg.chat_id_,Mohammad)
msg.text = Mohammad:gsub(Mohammad,mmdi)
end
end
local GetMsg = Plug.ikastlo(msg,{msg.text:match(kastlo)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",kastlo.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
if Plug.dkastlo then
Plug.dkastlo(msg)
print("\27[1;35m¦Msg_IN_Process : \27[1;32"..name.."\27[0m")
end
else
print("The File "..name.." Not Runing in The Source kastlo")
end 

end
else
print("The File Script.lua Not Runing in The Source kastlo")
...
function tdcli_update_callback(data)
	...
	redis:srem(kastlo..'users',msg.sender_user_id_)
	end
	...
	download_file('https://raw.githubusercontent.com/jack1eljoker1/kastlo2/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |V E       |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/kastlo2/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |V E      |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/kastlo2/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |V E N   |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/kastlo2/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/kastlo2/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/kastlo2/main/plugins/games.lua','./plugins/games.lua')
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	mmd = redis:get(kastlo..":SUDO_ID:")
redis:hset(kastlo..'username:'..tonumber(mmd),'username',msg.text)
	...
	redis:set(kastlo..":SUDO_ID:",msg.text)
...
download(stk,32)
	...
	if redis:get(kastlo..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(kastlo..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(kastlo..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(kastlo..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(kastlo..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(kastlo..'lock_bots'..msg.chat_id_)
	ISBOT = false
	...
	if ZISBOT and redis:get(kastlo..'lock_bots_by_kick'..msg.chat_id_) then
	kick_user(msg.sender_user_id_, msg.chat_id_)
	end
...
if redis:get(kastlo..'lock:join:'..msg.chat_id_) then
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	if redis:get(kastlo..'group:add'..data.chat_.id_) then
	redis:set(kastlo..'group:name'..data.chat_.id_,data.chat_.title_)
	end
	...
	if redis:get(kastlo..'group:add-100'..data.channel_.id_) then
	local linkGroup = (redis:get(kastlo..'linkGroup-100'..data.channel_.id_) or "")
	local NameGroup = (redis:get(kastlo..'group:name-100'..data.channel_.id_) or "")
	...
	redis:mset(
	kastlo..'group:name'..k,IDS.Title,
	kastlo..'num_msg_kastlo'..k,5,
	kastlo..'group:add'..k,true,
	kastlo..'lock_link'..k,true,
	kastlo..'lock_spam'..k,true,
	kastlo..'lock_webpage'..k,true,
	kastlo..'lock_markdown'..k,true,
	kastlo..'lock_flood'..k,true,
	kastlo..'lock_bots'..k,true,
	kastlo..'mute_forward'..k,true,
	kastlo..'mute_contact'..k,true,
	kastlo..'mute_document'..k,true,
	kastlo..'mute_inline'..k,true,
	kastlo..'lock_username'..k,true,
	kastlo..'replay'..k,true
	)
	redis:sadd(kastlo..'group:ids',k) 

	if IDS.Admins then
	for user,ID in pairs(IDS.Admins) do
	redis:hset(kastlo..'username:'..ID,'username',user)
	redis:sadd(kastlo..'admins:'..k,ID)
	end
	end
	if IDS.Creator then
	for user,ID in pairs(IDS.Creator) do
	redis:hset(kastlo..'username:'..ID,'username',user)
	redis:sadd(kastlo..':MONSHA_BOT:'..k,ID)
	end
	end
	if IDS.Owner then
	for user,ID in pairs(IDS.Owner) do
	redis:hset(kastlo..'username:'..ID,'username',user)
	redis:sadd(kastlo..'owners:'..k,ID)
	end
	end
	end
	io.popen("rm -fr ../.telegram-cli/data/document/*")
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'▪️ ** تم رفع النسخه‏‏ الاحتياطيه\n▪️ ** حالياً عدد مجموعاتك هيه‏ *'..redis:scard(kastlo..'group:ids')..' .*\n')
	end
	elseif data.ID == "UpdateUser" then  
	if data.user_.type_.ID == "UserTypeDeleted" then
	print("¦ userTypeDeleted")
	redis:srem(kastlo..'users',data.user_.id_)
	elseif data.user_.type_.ID == "UserTypeGeneral" then
	local CheckUser = redis:hgetall(kastlo..'username:'..data.user_.id_).username
	...
	redis:hset(kastlo..'username:'..data.user_.id_,'username',USERNAME)
	end 
	end
