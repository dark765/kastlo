...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(kastlo..":NameBot:")
...
var =  'المبرمج تركي'
elseif  UserID == 1078602906 then
var =  'مطور السورس'
elseif  UserID == 90909090809000 then
var =  'مطور السورس'
elseif redis:sismember(kastlo..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(kastlo..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(kastlo..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(kastlo..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(kastlo..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(kastlo..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(kastlo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(kastlo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(kastlo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(kastlo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(kastlo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(kastlo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(kastlo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(kastlo..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(kastlo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(kastlo..':SUDO_BOT:')
message = '♡ ** قائمه الـمـطـوريـن : \n\n`♡ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(kastlo..'username:'..v)
local count = redis:scard(kastlo..'mtwr_count'..v)
...
local monsha = redis:smembers(kastlo..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n♡ قائمه المدراء :*\n\n'
local list = redis:smembers(kastlo..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(kastlo..'admins:'..msg.chat_id_)
...
local list = redis:smembers(kastlo..'whitelist:'..msg.chat_id_)
...
if redis:sismember(kastlo..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(kastlo..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(kastlo..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(kastlo..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(kastlo..'gban_users')
...
local list = redis:smembers(kastlo..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(kastlo..':Filter_Word:'..msg.chat_id_,word) then 
return  "♡ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(kastlo..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(kastlo..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(kastlo..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(kastlo..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(kastlo..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(kastlo..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(kastlo..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(kastlo..'group:ids')
message = '♡ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(kastlo..'group:name'..v)
if info then 
...
<link href="https://fonts.kastloapis.com/css?family=Harmattan" rel="stylesheet">
...
redis:del(
kastlo..'group:add'..id_group,
kastlo..'lock_link'..id_group, 
kastlo..'lock_id'..id_group,
kastlo..'lock_spam'..id_group, 
kastlo..'lock_webpage'..id_group,
kastlo..'lock_markdown'..id_group,
kastlo..'lock_flood'..id_group,
kastlo..'lock_bots'..id_group,
kastlo..'mute_forward'..id_group,
kastlo..'mute_contact'..id_group,
kastlo..'mute_location'..id_group,
kastlo..'mute_document'..id_group,
kastlo..'mute_keyboard'..id_group,
kastlo..'mute_game'..id_group,
kastlo..'mute_inline'..id_group,
kastlo..'lock_username'..id_group,
kastlo..'num_msg_kastlo'..id_group,
kastlo..'replay'..id_group
)
redis:srem(kastlo..'group:ids',id_group)
end
...
redis:hset(kastlo..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(kastlo..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(kastlo..'group:add'..msg.chat_id_) then  return '♡ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(kastlo..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(kastlo..':addnumberusers') or 0)
...
local lock_service = redis:get(kastlo..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(kastlo..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(kastlo..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
kastlo..'group:add'..msg.chat_id_,true,
kastlo..'lock_link'..msg.chat_id_,true, 
kastlo..'lock_id'..msg.chat_id_,true,
kastlo..'lock_spam'..msg.chat_id_,true,
kastlo..'lock_webpage'..msg.chat_id_,true,
kastlo..'lock_markdown'..msg.chat_id_,true,
kastlo..'lock_flood'..msg.chat_id_,true,
kastlo..'lock_bots'..msg.chat_id_,true,
kastlo..'mute_forward'..msg.chat_id_,true,
kastlo..'mute_contact'..msg.chat_id_,true,
kastlo..'mute_location'..msg.chat_id_,true,
kastlo..'mute_document'..msg.chat_id_,true,
kastlo..'mute_keyboard'..msg.chat_id_,true,
kastlo..'mute_game'..msg.chat_id_,true,
kastlo..'mute_inline'..msg.chat_id_,true,
kastlo..'lock_username'..msg.chat_id_,true,
kastlo..'num_msg_kastlo'..msg.chat_id_,5, 
kastlo..'replay'..msg.chat_id_,true
)

redis:sadd(kastlo..'group:ids',msg.chat_id_) 
redis:sadd(kastlo..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(kastlo..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(kastlo..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(kastlo..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(kastlo..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(kastlo..'username:'..UserID,'username',Resolv)
redis:sadd(kastlo..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(kastlo..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(kastlo..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(kastlo..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(kastlo..'username:'..UserID,'username',Resolv)
redis:sadd(kastlo..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(kastlo..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(kastlo..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(kastlo..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(kastlo..'username:'..UserID, 'username', Resolv)
redis:sadd(kastlo..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(kastlo..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(kastlo..'whitelist:'..ChatID,UserID)
...
if redis:sismember(kastlo..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(kastlo..'username:'..UserID, 'username', Resolv)
redis:sadd(kastlo..'owners:'..ChatID,UserID)
...
if redis:sismember(kastlo..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(kastlo..'username:'..UserID, 'username', Resolv)
redis:sadd(kastlo..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(kastlo..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(kastlo..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(kastlo..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(kastlo..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(kastlo..'msgs:'..UserID..':'..ChatID) or 1
...
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك حظر المبرمج دارك\n") 
elseif UserID == 1078602906 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك حظر مطور السورس\n") 
elseif UserID == 1019610884 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك حظر المبرمج تركي\n") 
elseif UserID == 90909090809000 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك حظر مطور السورس\n") 
elseif redis:sismember(kastlo..':SUDO_BOT:',UserID) then 
...
redis:hset(kastlo..'username:'..UserID, 'username', Resolv)
redis:sadd(kastlo..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(kastlo..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(kastlo..'banned:'..ChatID,UserID)
...
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك كتم المبرمج دارك\n") 
elseif UserID == 1078602906 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك كتم مطور السورس\n") 
elseif UserID == 1019610884 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك كتم المبرمج تركي\n") 
elseif UserID == 90909090809000 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك كتم مطور السورس\n") 
elseif redis:sismember(kastlo..':SUDO_BOT:',UserID) then 
...
if redis:sismember(kastlo..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(kastlo..'username:'..UserID, 'username', Resolv)
redis:sadd(kastlo..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(kastlo..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(kastlo..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(kastlo..'username:'..UserID, 'username',Resolv)
redis:sadd(kastlo..'gban_users',UserID)
...
redis:srem(kastlo..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم الغاء حظره العام \n',17,USERCAR) 
end
...
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك طرد المبرمج دارك\n") 
elseif UserID == 1078602906 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك طرد مطور السورس\n") 
elseif UserID == 1019610884 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك طرد المبرمج تركي\n") 
elseif UserID == 90909090809000 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك كتم مطور السورس\n") 
elseif redis:sismember(kastlo..':SUDO_BOT:',UserID) then 
...
if redis:sismember(kastlo..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(kastlo..'username:'..UserID, 'username', Resolv)
redis:sadd(kastlo..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(kastlo..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(kastlo..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك تقييد المطور الاساسي\n") 
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك تقييد المبرمج دارك\n") 
elseif UserID == 1019610884 then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك تقييد المبرمج تركي\n") 
elseif UserID == 1078602906 then 
...
redis:hset(kastlo..'username:'..UserID, 'username', UserName)
redis:sadd(kastlo..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(kastlo..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'♡ **العضو » ❪ '..UserName..' ❫\n♡ **الايدي » ❪ `'..UserID..'` ❫\n♡ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(kastlo..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(kastlo..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"♡ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(kastlo..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(kastlo..'username:'..UserID, 'username', Resolv)
redis:sadd(kastlo..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(kastlo..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(kastlo..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'♡ **العضو » '..USERNAME..' \n♡ ** الايدي » (`'..UserID..'`)\n♡ **انه بالتأكيد ليس مطور \n') end
redis:srem(kastlo..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'♡ العضو » ❪ '..USERNAME..' ❫\n♡ الايدي » ❪ '..UserID..' ❫\n♡ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(kastlo..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(kastlo..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(kastlo..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(kastlo..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*♡*` اعدادات المجموعه :` \n"
.."\n♡ التعديل «» "..(redis:get(kastlo..'lock_edit'..msg.chat_id_) or 'false')
.."\n♡ الروابط «» "..(redis:get(kastlo..'lock_link'..msg.chat_id_) or 'false')
.."\n♡ التاك «» "..(redis:get(kastlo..'lock_tag'..msg.chat_id_) or 'false')
.."\n♡ المعرفات «» "..(redis:get(kastlo..'lock_username'..msg.chat_id_) or 'false')
.."\n♡ التكرار «» "..(redis:get(kastlo..'lock_flood'..msg.chat_id_) or 'false')
.."\n♡ الكلايش «» "..(redis:get(kastlo..'lock_spam'..msg.chat_id_) or 'false')
.."\n♡ الويب «» "..(redis:get(kastlo..'lock_webpage'..msg.chat_id_) or 'false')
.."\n♡ الماركدوان «» "..(redis:get(kastlo..'lock_markdown'..msg.chat_id_) or 'false')
.."\n♡ بالطرد البوتات «» "..(redis:get(kastlo..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n♡ البوتات «» "..(redis:get(kastlo..'lock_bots'..msg.chat_id_) or 'false')
.."\n♡ عدد التكرار «» "..(redis:get(kastlo..'num_msg_kastlo'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n♡`اعدادات الوسائط :`\n"
.."\n*♡ *المتحركه «» "..(redis:get(kastlo..'mute_gif'..msg.chat_id_) or 'false')
.."\n♡ الدردشه «» "..(redis:get(kastlo..'mute_text'..msg.chat_id_) or 'false')
.."\n♡ الانلاين «» "..(redis:get(kastlo..'mute_inline'..msg.chat_id_) or 'false')
.."\n♡ الالعاب «» "..(redis:get(kastlo..'mute_game'..msg.chat_id_) or 'false')
.."\n♡ الصور «» "..(redis:get(kastlo..'mute_photo'..msg.chat_id_) or 'false')
.."\n♡ الفيديو «» "..(redis:get(kastlo..'mute_video'..msg.chat_id_) or 'false')
.."\n♡ البصمات «» "..(redis:get(kastlo..'mute_audio'..msg.chat_id_) or 'false')
.."\n♡ الصوت «» "..(redis:get(kastlo..'mute_voice'..msg.chat_id_) or 'false')
.."\n♡ الملصقات «» "..(redis:get(kastlo..'mute_sticker'..msg.chat_id_) or 'false')
.."\n♡ الجهات «» "..(redis:get(kastlo..'mute_contact'..msg.chat_id_) or 'false')
.."\n♡ التوجيه «» "..(redis:get(kastlo..'mute_forward'..msg.chat_id_) or 'false')
.."\n♡ الموقع «» "..(redis:get(kastlo..'mute_location'..msg.chat_id_) or 'false')
.."\n♡ الملفات «» "..(redis:get(kastlo..'mute_document'..msg.chat_id_) or 'false')
.."\n♡ الاشعارات «» "..(redis:get(kastlo..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n♡ الكيبورد «» "..(redis:get(kastlo..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*♡*`اعدادات اخرى : `"
.."\n\n*♡*الترحيب «» "..welcomex
.."\n*♡*الردود «» "..replayx
...
.."\n*♡*الويب «» "..(redis:get(kastlo..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*♡*الماركدوان «» "..(redis:get(kastlo..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*♡*البوتات بالطرد «» "..(redis:get(kastlo..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*♡*البوتات «» "..(redis:get(kastlo..'lock_bots'..msg.chat_id_) or 'false')
.."\n*♡*عدد التكرار «» "..(redis:get(kastlo..'num_msg_kastlo'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*♡*اعدادات التقـييد :\n"
.."\n*♡*التقييد بالتوجيه «» "..(redis:get(kastlo..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالصور «» "..(redis:get(kastlo..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالروابط «» "..(redis:get(kastlo..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد بالمتحركه «» "..(redis:get(kastlo..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*♡*التقييد الفيديو «» "..(redis:get(kastlo..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
